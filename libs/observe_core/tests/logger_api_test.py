"""Unit tests for custom logger behavior, timers, and logger factory helpers."""
...
class TestLoggerApi(unittest.TestCase):
    """Test suite for observe_api.core.logger_api.LoggerApi."""
    ...
    def test_logger_instance(self):
        ...
        self.assertIsInstance(logger, LoggerApi)
    ...
    def test_dec_time_it_decorator(self):
        ...
        self.assertIn("decorator_timer", logger._timers_it)
    ...
    #     self.assertIn("timer1", captured)
    #     self.assertIn("timer2", captured)
    #     self.assertIn("TOTAL", captured)
    ...
    def test_get_logger_function(self):
        ...
        self.assertEqual(l.name, "another_logger")
