"""Unit tests for system information helpers and memory usage utilities."""

import unittest
from unittest.mock import patch

from observe_core import info


class TestInfoModule(unittest.TestCase):
    """Test suite for observe_api.core.info functions."""
    ...
    @patch("observe_core.info.info_hardware")
    @patch("observe_core.info.info_gpu")
    @patch("observe_core.info.info_os")
    @patch("observe_core.info.info_software")
